...
function KeyboardInput(entryTitle, textEntry, inputText, maxLength)
 ...
 local depot = RageUI.CreateSubMenu(mainMenu, "Objet", "Dépôt")
 local retrait = RageUI.CreateSubMenu(mainMenu, 'Objet', 'Retrait')
 local argent = RageUI.CreateSubMenu(mainMenu, 'Coffre-fort', 'Action')
 local permissionmenu = RageUI.CreateSubMenu(mainMenu, 'Permission', 'Action')
 local permissiondepot = RageUI.CreateSubMenu(permissionmenu, 'Dépôt (Item)', 'Permission')
 local permissionretrait = RageUI.CreateSubMenu(permissionmenu, 'Retrait (Item)', 'Permission')
 local permissiondepotargent = RageUI.CreateSubMenu(permissionmenu, 'Dépôt (Argent)', 'Permission')
 local permissionretraitargent = RageUI.CreateSubMenu(permissionmenu, 'Retrait (Argent)', 'Permission')
 local permissiondepotarme = RageUI.CreateSubMenu(permissionmenu, 'Dépôt (Arme)', 'Permission')
 local permissionretraitarme = RageUI.CreateSubMenu(permissionmenu, 'Retrait (Arme)', 'Permission')
 local permissioncoffrefort = RageUI.CreateSubMenu(permissionmenu, 'Coffre Fort', 'Permission')
 local depositweapon = RageUI.CreateSubMenu(mainMenu, 'Arme', 'Dépôt')
 local retraitweapon = RageUI.CreateSubMenu(mainMenu, 'Arme', 'Retrait')
