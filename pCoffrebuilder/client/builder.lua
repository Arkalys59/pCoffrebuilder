...
function KeyboardInput(entryTitle, textEntry, inputText, maxLength)
 ...
 -- MENU
 local mainMenu = RageUI.CreateMenu("Coffre Builder", "Action") 
 local creationcoffre = RageUI.CreateSubMenu(mainMenu, "Création Coffre", "Action")
 local modificationCoffre = RageUI.CreateSubMenu(mainMenu, 'Modification Coffre', 'Action')
 local actionmodification = RageUI.CreateSubMenu(modificationCoffre, 'Modification', 'Action')
 local modificationinformationcoffre = RageUI.CreateSubMenu(modificationCoffre, 'Modification', 'Information Coffre')
 local argentmodificationcoffre = RageUI.CreateSubMenu(mainMenu, 'Argent', 'Modification')
 local StockageMenuStaff = RageUI.CreateSubMenu(modificationCoffre, 'Contenue Coffre', 'Action')
 local StockageMenuStafff = RageUI.CreateSubMenu(modificationCoffre, 'Contenue Coffre', 'Action')
